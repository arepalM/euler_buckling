...
cubit.cmd('create curve arc vertex 26 29  radius 30000 normal 0 0 1 ')
cubit.cmd('create curve arc vertex 43 48  radius 30000 normal 0 0 1 ')
cubit.cmd('create surface  101 97 102 91')
cubit.cmd('merge all')
cubit.cmd('##left surface')
cubit.cmd('create curve arc vertex 25 30 radius 30000 normal 0 0 1 ')
cubit.cmd('create surface 105 41 101 37')
cubit.cmd('merge all')
cubit.cmd('## right surface')
cubit.cmd('create curve arc vertex 44 47 radius 30000 normal 0 0 1 ')
...
cubit.cmd('export abaqus "C:/Users/hokie/OneDrive - Johns Hopkins/Documents/JHU/Research/morphing wing/Abaqus/buckling/elastic_hex20/iter_30000/part_30000.inp" overwrite everything')
